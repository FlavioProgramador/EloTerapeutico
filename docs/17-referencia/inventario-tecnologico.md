...
| `msgpack` | `>=1.2.1` | Serialização binária eficiente para Celery |
| `setuptools` | `>=78.1.1` | Gerenciamento e build de pacotes Python |
...
| --- | --- | --- |
| ESLint | `^9` | Lint |
| eslint-config-next | `16.3.3` | Regras Next.js |

...
Cada página reúne finalidade, situação, entidades, regras, API, frontend, permissões, segurança, testes e limitações. Módulos pequenos foram consolidados em um único documento para evitar arquivos vazios ou repetitivos.

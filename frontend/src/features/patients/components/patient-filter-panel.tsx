      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ...
          return (
            <div key={key} className="flex flex-col gap-1">
              ...
              <select
                ...
                className="h-10 w-full rounded-md border border-border bg-background px-3 text-xs font-normal text-foreground outline-none transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2"
              >
        ...
        <div className="flex h-10 items-center gap-2 self-end rounded-md border border-border bg-background px-3 text-xs text-foreground focus-within:ring-2 focus-within:ring-primary/40 focus-within:ring-offset-2">
          <input
            ...
            className="accent-primary rounded h-4 w-4 border-input text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2"
          />
          <label
            htmlFor={`${baseId}-no-next-session`}
            className="cursor-pointer select-none text-[10px] font-semibold text-muted-foreground"
          >
            Sem próxima sessão
          </label>
        </div>

      ...
      {submit.editing && state.patientQuery.isLoading ? (
        ...
        <form onSubmit={submit.submit} className="space-y-6 pb-8" noValidate>
          ...
          <div className="space-y-4">
            ...
            >
              <input
                ...
                aria-describedby={errors.full_name ? `${baseId}-full-name-error` : undefined}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="E-mail" error={errors.email?.message} id={`${baseId}-email`}>
                <input
                  id={`${baseId}-email`}
                  type="email"
              ...
              <FormField label="Telefone" error={errors.phone?.message} id={`${baseId}-phone`}>
                <input
                  id={`${baseId}-phone`}
                  type="text"
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="Data de Nascimento *" error={errors.birth_date?.message} id={`${baseId}-birth-date`}>
                <input
                  id={`${baseId}-birth-date`}
                  type="date"
                  max={today}
                  aria-describedby={errors.birth_date ? `${baseId}-birth-date-error` : undefined}
              ...
              <FormField label="Início dos Atendimentos" error={errors.treatment_start_date?.message} id={`${baseId}-treatment-start-date`}>
                <input
                  id={`${baseId}-treatment-start-date`}
                  type="date"
                  max={today}
                  aria-describedby={errors.treatment_start_date ? `${baseId}-treatment-start-date-error` : undefined}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="CPF *" error={errors.cpf?.message} id={`${baseId}-cpf`}>
                <input
                  id={`${baseId}-cpf`}
                  type="text"
                  placeholder="000.000.000-00"
                  aria-describedby={errors.cpf ? `${baseId}-cpf-error` : undefined}
              ...
              <FormField label="RG" error={errors.rg?.message} id={`${baseId}-rg`}>
                <input
                  id={`${baseId}-rg`}
                  type="text"
                  placeholder="00.000.000-0"
                  aria-describedby={errors.rg ? `${baseId}-rg-error` : undefined}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="Profissão" error={errors.profession?.message} id={`${baseId}-profession`}>
                <input
                  id={`${baseId}-profession`}
                  type="text"
                  placeholder="Profissão"
                  aria-describedby={errors.profession ? `${baseId}-profession-error` : undefined}
              ...
              <FormField label="Rede Social" error={errors.social_network?.message} id={`${baseId}-social-network`}>
                <input
                  id={`${baseId}-social-network`}
                  type="text"
                  placeholder="@instagram"
                  aria-describedby={errors.social_network ? `${baseId}-social-network-error` : undefined}
          ...
          <div className="space-y-4">
            ...
            <FormField label="Convênio" error={errors.payer_type?.message} id={`${baseId}-payer-type`}>
              <select
                id={`${baseId}-payer-type`}
                aria-describedby={errors.payer_type ? `${baseId}-payer-type-error` : undefined}
            ...
            {watchPayerType === "insurance" && (
              <FormField label="Nome do convênio *" error={errors.insurance_name?.message} id={`${baseId}-insurance-name`}>
                <input
                  id={`${baseId}-insurance-name`}
                  type="text"
                  placeholder="Nome do convênio"
                  aria-describedby={errors.insurance_name ? `${baseId}-insurance-name-error` : undefined}
            ...
            <FormField label="Valor do Atendimento (R$)" error={errors.session_value?.message} id={`${baseId}-session-value`}>
              <input
                id={`${baseId}-session-value`}
                type="text"
                placeholder="0,00"
                aria-describedby={errors.session_value ? `${baseId}-session-value-error` : undefined}
            ...
            >
              <select
                id={`${baseId}-reminder-recipient`}
                aria-describedby={errors.reminder_recipient ? `${baseId}-reminder-recipient-error` : undefined}
          ...
          <div className="space-y-4">
            ...
            <FormField label="CEP" error={errors.address_zip_code?.message} id={`${baseId}-address-zip-code`} className="w-1/2 pr-1.5">
              <input
                id={`${baseId}-address-zip-code`}
                type="text"
                placeholder="00000-000"
                aria-describedby={errors.address_zip_code ? `${baseId}-address-zip-code-error` : undefined}
            ...
            <div className="flex gap-3">
              <FormField label="Rua/Avenida" error={errors.address_street?.message} id={`${baseId}-address-street`} className="flex-[3]">
                <input
                  id={`${baseId}-address-street`}
                  type="text"
                  placeholder="Nome da rua"
                  aria-describedby={errors.address_street ? `${baseId}-address-street-error` : undefined}
              ...
              <FormField label="Número" error={errors.address_number?.message} id={`${baseId}-address-number`} className="flex-[1]">
                <input
                  id={`${baseId}-address-number`}
                  type="text"
                  placeholder="123"
                  aria-describedby={errors.address_number ? `${baseId}-address-number-error` : undefined}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="Complemento" error={errors.address_complement?.message} id={`${baseId}-address-complement`}>
                <input
                  id={`${baseId}-address-complement`}
                  type="text"
                  placeholder="Apto, Bloco..."
                  aria-describedby={errors.address_complement ? `${baseId}-address-complement-error` : undefined}
              ...
              <FormField label="Bairro" error={errors.address_neighborhood?.message} id={`${baseId}-address-neighborhood`}>
                <input
                  id={`${baseId}-address-neighborhood`}
                  type="text"
                  placeholder="Nome do bairro"
                  aria-describedby={errors.address_neighborhood ? `${baseId}-address-neighborhood-error` : undefined}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="Cidade" error={errors.address_city?.message} id={`${baseId}-address-city`}>
                <input
                  id={`${baseId}-address-city`}
                  type="text"
                  placeholder="Cidade"
                  aria-describedby={errors.address_city ? `${baseId}-address-city-error` : undefined}
              ...
              <FormField label="Estado" error={errors.address_state?.message} id={`${baseId}-address-state`}>
                <select
                  id={`${baseId}-address-state`}
                  aria-describedby={errors.address_state ? `${baseId}-address-state-error` : undefined}
          ...
          <div className="rounded-xl border border-amber-500/25 bg-amber-500/5 p-4 space-y-4 mt-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="Nome do Contato" error={errors.emergency_contact_name?.message} id={`${baseId}-emergency-contact-name`}>
                <input
                  id={`${baseId}-emergency-contact-name`}
                  type="text"
                  placeholder="Nome do contato de emergência"
                  aria-describedby={errors.emergency_contact_name ? `${baseId}-emergency-contact-name-error` : undefined}
              ...
              <FormField label="Telefone de Emergência" error={errors.emergency_contact_phone?.message} id={`${baseId}-emergency-contact-phone`}>
                <input
                  id={`${baseId}-emergency-contact-phone`}
                  type="text"
                  placeholder="(11) 99999-9999 ou +55 21 99999-9999"
                  aria-describedby={errors.emergency_contact_phone ? `${baseId}-emergency-contact-phone-error` : undefined}
          ...
          {state.isMinor && (
            <div className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <FormField label="Nome *" error={errors.guardian_name?.message} id={`${baseId}-guardian-name`}>
                  <input
                    id={`${baseId}-guardian-name`}
                    type="text"
                    placeholder="Nome do responsável legal"
                    aria-describedby={errors.guardian_name ? `${baseId}-guardian-name-error` : undefined}
                ...
                <FormField label="CPF *" error={errors.guardian_cpf?.message} id={`${baseId}-guardian-cpf`}>
                  <input
                    id={`${baseId}-guardian-cpf`}
                    type="text"
                    placeholder="000.000.000-00"
                    aria-describedby={errors.guardian_cpf ? `${baseId}-guardian-cpf-error` : undefined}
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <FormField label="Telefone *" error={errors.guardian_phone?.message} id={`${baseId}-guardian-phone`}>
                  <input
                    id={`${baseId}-guardian-phone`}
                    type="text"
                    placeholder="(11) 99999-9999 ou +55 21 99999-9999"
                    aria-describedby={errors.guardian_phone ? `${baseId}-guardian-phone-error` : undefined}
                ...
                <FormField label="E-mail *" error={errors.guardian_email?.message} id={`${baseId}-guardian-email`}>
                  <input
                    id={`${baseId}-guardian-email`}
                    type="email"
                    placeholder="email@exemplo.com"
                    aria-describedby={errors.guardian_email ? `${baseId}-guardian-email-error` : undefined}
              ...
              <FormField label="Vínculo / Relacionamento" error={errors.guardian_relationship?.message} id={`${baseId}-guardian-relationship`}>
                <input
                  id={`${baseId}-guardian-relationship`}
                  type="text"
                  placeholder="Ex: Mãe, Pai, Tutor..."
                  aria-describedby={errors.guardian_relationship ? `${baseId}-guardian-relationship-error` : undefined}
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="Nome" error={errors.financial_responsible_name?.message} id={`${baseId}-financial-responsible-name`}>
                <input
                  id={`${baseId}-financial-responsible-name`}
                  type="text"
                  placeholder="Nome do responsável financeiro"
                  aria-describedby={errors.financial_responsible_name ? `${baseId}-financial-responsible-name-error` : undefined}
              ...
              <FormField label="CPF" error={errors.financial_responsible_cpf?.message} id={`${baseId}-financial-responsible-cpf`}>
                <input
                  id={`${baseId}-financial-responsible-cpf`}
                  type="text"
                  placeholder="000.000.000-00"
                  aria-describedby={errors.financial_responsible_cpf ? `${baseId}-financial-responsible-cpf-error` : undefined}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <FormField label="Telefone" error={errors.financial_responsible_phone?.message} id={`${baseId}-financial-responsible-phone`}>
                <input
                  id={`${baseId}-financial-responsible-phone`}
                  type="text"
                  placeholder="(11) 99999-9999 ou +55 21 99999-9999"
                  aria-describedby={errors.financial_responsible_phone ? `${baseId}-financial-responsible-phone-error` : undefined}
              ...
              <FormField label="E-mail" error={errors.financial_responsible_email?.message} id={`${baseId}-financial-responsible-email`}>
                <input
                  id={`${baseId}-financial-responsible-email`}
                  type="email"
                  placeholder="email@exemplo.com"
                  aria-describedby={errors.financial_responsible_email ? `${baseId}-financial-responsible-email-error` : undefined}
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <FormField label="Estado Civil" error={errors.financial_responsible_marital_status?.message} id={`${baseId}-financial-responsible-marital-status`}>
                <select
                  id={`${baseId}-financial-responsible-marital-status`}
                  aria-describedby={errors.financial_responsible_marital_status ? `${baseId}-financial-responsible-marital-status-error` : undefined}
              ...
              <FormField label="Naturalidade" error={errors.financial_responsible_naturality?.message} id={`${baseId}-financial-responsible-naturality`}>
                <input
                  id={`${baseId}-financial-responsible-naturality`}
                  type="text"
                  placeholder="Cidade/Estado"
                  aria-describedby={errors.financial_responsible_naturality ? `${baseId}-financial-responsible-naturality-error` : undefined}
              ...
              <FormField label="Ocupação" error={errors.financial_responsible_occupation?.message} id={`${baseId}-financial-responsible-occupation`}>
                <input
                  id={`${baseId}-financial-responsible-occupation`}
                  type="text"
                  placeholder="Ocupação"
                  aria-describedby={errors.financial_responsible_occupation ? `${baseId}-financial-responsible-occupation-error` : undefined}
          ...
          <div className="pt-2">
            ...
            {showAdditionalFields && (
              <div className="grid gap-4 mt-3 p-4 rounded-xl border border-border/50 bg-secondary/5 space-y-2 animate-in fade-in duration-200">
                <div className="grid gap-3 sm:grid-cols-2">
                  <FormField label="Gênero" error={errors.gender?.message} id={`${baseId}-gender`}>
                    <select
                      id={`${baseId}-gender`}
                      aria-describedby={errors.gender ? `${baseId}-gender-error` : undefined}
                  ...
                  <FormField label="Estado Civil do Paciente" error={errors.marital_status?.message} id={`${baseId}-marital-status`}>
                    <select
                      id={`${baseId}-marital-status`}
                      aria-describedby={errors.marital_status ? `${baseId}-marital-status-error` : undefined}
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <FormField label="Tipo de Atendimento" error={errors.attendance_type?.message} id={`${baseId}-attendance-type`}>
                    <select
                      id={`${baseId}-attendance-type`}
                      aria-describedby={errors.attendance_type ? `${baseId}-attendance-type-error` : undefined}
                  ...
                  <FormField label="Modalidade" error={errors.modality?.message} id={`${baseId}-modality`}>
                    <select
                      id={`${baseId}-modality`}
                      aria-describedby={errors.modality ? `${baseId}-modality-error` : undefined}
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <FormField label="Frequência" error={errors.planned_frequency?.message} id={`${baseId}-planned-frequency`}>
                    <select
                      id={`${baseId}-planned-frequency`}
                      aria-describedby={errors.planned_frequency ? `${baseId}-planned-frequency-error` : undefined}
                  ...
                  <FormField label="Etiquetas (separadas por vírgula)" error={errors.tags?.message} id={`${baseId}-tags`}>
                    <input
                      id={`${baseId}-tags`}
                      type="text"
                      placeholder="Ex: TCC, Ansiedade"
                      aria-describedby={errors.tags ? `${baseId}-tags-error` : undefined}
                ...
                <FormField label="Origem / Indicação" error={errors.referral_source?.message} id={`${baseId}-referral-source`}>
                  <input
                    id={`${baseId}-referral-source`}
                    type="text"
                    placeholder="Ex: Google, Recomendação médica"
                    aria-describedby={errors.referral_source ? `${baseId}-referral-source-error` : undefined}
          ...
          <div className="space-y-4">
            ...
            <FormField label="Observações" error={errors.notes?.message} id={`${baseId}-notes`}>
              <textarea
                id={`${baseId}-notes`}
                placeholder="Observações sobre o paciente..."
                aria-describedby={errors.notes ? `${baseId}-notes-error` : undefined}

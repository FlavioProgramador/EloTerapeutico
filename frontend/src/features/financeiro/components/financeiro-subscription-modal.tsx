      ...
      <form className="space-y-5" onSubmit={submit}>
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="h-11 w-full rounded-lg border border-input bg-card px-3 text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"

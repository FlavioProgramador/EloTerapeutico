      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-2xl text-white">
          ...
          <p className="text-lg md:text-xl text-[#EFF3EE]/90 mb-10 font-body">
            Oferecemos uma plataforma completa e acolhedora, trazendo conforto,
            segurança e paz de espírito para você e seus pacientes, do
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-xl">
            ...
            <p className="text-muted-foreground text-lg mb-10 leading-relaxed font-body">
              O Elo Terapêutico foi fundado com o objetivo de simplificar a
              rotina clínica de psicólogos e terapeutas. Focamos em entregar
              segurança de dados, prontuários eficientes e uma gestão
              descomplicada para que você tenha mais tempo para se dedicar ao
              que realmente importa: seus pacientes.
            </p>
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-12 gap-6">
          ...
          <p className="text-muted-foreground max-w-md text-lg font-body">
            Oferecemos um sistema seguro, respeitoso e premium, com tecnologia
            de ponta para a sua clínica.
          </p>
        </div>
  ...
  const features = [
    {
      ...
      icon: Calendar,
      text: "Controle seus horários com facilidade.",
    },
    {
      title: "Financeiro Integrado",
      icon: Banknote,
      text: "Receitas, despesas e relatórios em um clique.",
    },
    {
      title: "Prontuário Especializado",
      icon: Brain,
      text: "Evoluções seguras com modelos terapêuticos.",
    },
    {
      title: "Suporte Dedicado",
      icon: Headset,
      text: "Atendimento humano pronto para ajudar.",
    },
    {
      title: "Conformidade LGPD",
      icon: Shield,
      text: "Dados criptografados de ponta a ponta.",
    },
    {
      title: "Intuitivo e Fácil",
      icon: Lightbulb,
      text: "Uma interface amigável para o dia a dia.",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg font-body">
            Ferramentas pensadas para acolhimento e expertise — para que seus
            atendimentos sejam feitos com segurança, organização e dignidade.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <div
              key={i}
              className="group bg-card border border-border p-6 rounded-2xl hover:border-accent transition-all hover:shadow-lg flex items-center justify-between cursor-pointer"
            >
  ...
  return (
    <section className="py-24 bg-background text-foreground" id="detalhes">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-display font-bold text-primary mb-6">
            Molde o cuidado com o Elo
          </h2>
          <p className="text-muted-foreground text-lg font-body">
            A melhor solução em um só lugar para que você tenha todas as
            ferramentas necessárias para uma gestão clínica impecável.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            <div className="bg-card border border-border p-8 rounded-2xl h-full">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Mantenha todos os detalhes de atendimento em um ambiente seguro.
                Fique conectado, informado e no controle de sua base de
            ...
            <div className="bg-card border border-border p-8 rounded-2xl h-full">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Nossos planos de acompanhamento se adaptam à evolução do
                paciente. Desenhado cuidadosamente para garantir organização,
                privacidade e consistência.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            <div className="bg-card border border-border p-8 rounded-2xl h-full">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Explore nosso acervo de materiais e escalas validadas. Encontre
                a ferramenta certa para proporcionar um suporte personalizado e
                confiável.
              </p>
            </div>
            <div className="bg-card border border-border p-8 rounded-2xl h-full">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Acompanhe o progresso diário, anotações e atividades em um só
                lugar. Tenha confiança de que as necessidades de cada paciente

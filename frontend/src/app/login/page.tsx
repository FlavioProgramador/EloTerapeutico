    ...
    try {
      ...
      if (data) {
        if (
          ...
          serverMessage = (data.error as Record<string, unknown>)
            .message as string;
          ...
          >
            <div className="space-y-6">
              <div className="space-y-2 group">
                <label
                  htmlFor="login-email"
                  className="text-xs font-bold text-gray-400 uppercase tracking-wider group-focus-within:text-[#F97316] transition-colors duration-300"
                >
                  E-mail
                </label>
                <Input

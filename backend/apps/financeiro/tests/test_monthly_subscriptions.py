...
from apps.financeiro.models import MonthlySubscription
...
def test_create_and_list_subscription(subscription_context):
    ...
    created = client.post("/api/v1/financeiro/subscriptions/", payload, format="json")
    listed = client.get("/api/v1/financeiro/subscriptions/")

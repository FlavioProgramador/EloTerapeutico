...
def test_batch_billing_is_idempotent(billing_context):
    ...
    first = client.post("/api/v1/financeiro/generate-monthly-charges/", payload, format="json")
    second = client.post("/api/v1/financeiro/generate-monthly-charges/", payload, format="json")
...
def test_batch_billing_rejects_unknown_appointment(billing_context):
    ...
    response = client.post(
        "/api/v1/financeiro/generate-monthly-charges/",

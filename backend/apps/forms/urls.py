...
urlpatterns = [
    ...
    path("<int:form_id>/submissions/", FormSubmissionListCreateView.as_view(), name="forms-submissions"),
    ...
    path("from-template/<int:template_id>/", FormFromTemplateView.as_view(), name="forms-from-template"),
    path("submissions/<int:pk>/", FormSubmissionDetailView.as_view(), name="form-submission-detail"),
    path("submissions/<int:pk>/submit/", FormSubmissionSubmitView.as_view(), name="form-submission-submit"),
]

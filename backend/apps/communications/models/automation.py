...
class CommunicationAutomation(models.Model):
    ...
    fallback_channel = models.CharField(
        max_length=24,
        choices=Communication.Channel.choices,
        blank=True,
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["owner", "is_active", "event_type"],
                name="comm_auto_event_idx",
            ),
        ]
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["automation", "idempotency_key"],
                name="comm_auto_run_idem_uniq",
            )
        ]

...
class Command(BaseCommand):
    help = "Processa eventos de webhook de billing persistidos, com retry e lock transacional."

    def add_arguments(self, parser):
        parser.add_argument("--once", action="store_true", help="Processa a fila atual e encerra.")
        parser.add_argument("--sleep", type=float, default=2.0, help="Intervalo entre consultas da fila.")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Eventos processados nesta execução: {processed}"))

...
urlpatterns = [
    ...
    path(
        "plan-prices/",
        PlanPriceListView.as_view(),
        name="billing-plan-prices",
    ),
    path(
        "entitlement/",
    ...
    path(
        "payments/<int:pk>/refresh/",
        PaymentRefreshView.as_view(),
        name="billing-payment-refresh",
    ),
    path(
        "integrations/asaas/health/",

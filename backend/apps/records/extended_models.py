"""Modelos complementares do prontuário sem quebrar os contratos legados."""
...
class AnamnesisProfile(models.Model):
    """Campos ampliados da anamnese, vinculados à ficha legada."""
...
class AnamnesisVersion(models.Model):
    """Snapshot imutável criado antes de cada alteração da anamnese."""
...
class EvolutionClinicalData(models.Model):
    """Conteúdo estruturado de uma evolução, preservando o campo legado content."""
...
class EvolutionVersion(models.Model):
    """Versão imutável de evolução antes de uma alteração autorizada."""

...
class ClinicalAnamnesisView(ClinicalPatientMixin, APIView):
    def get(self, request, patient_id):
        ...
        log_access(request, AuditLog.Action.VIEW, obj=anamnesis, obj_repr=f"Anamnese #{anamnesis.id}")
    ...
    def _save(self, request, patient_id, partial):
        ...
        log_access(request, AuditLog.Action.UPDATE, obj=anamnesis, obj_repr=f"Anamnese #{anamnesis.id}")
...
class PatientEvolutionListCreateView(ClinicalPatientMixin, APIView):
    ...
    def post(self, request, patient_id):
        ...
        if session_date and Evolution.objects.filter(
            patient=patient,
        ...
        log_access(request, AuditLog.Action.CREATE, obj=evolution, obj_repr=f"Evolução #{evolution.id}")
...
class EvolutionWorkspaceDetailView(ClinicalPatientMixin, APIView):
    def get(self, request, pk):
        ...
        log_access(request, AuditLog.Action.VIEW, obj=evolution, obj_repr=f"Evolução #{evolution.id}")
    ...
    def patch(self, request, pk):
        ...
        serializer.is_valid(raise_exception=True)
        evolution = serializer.save()
        log_access(request, AuditLog.Action.UPDATE, obj=evolution, obj_repr=f"Evolução #{evolution.id}")
        return Response(self.serialize_evolution(evolution, request))
...
class EvolutionFinalizeView(ClinicalPatientMixin, APIView):
    ...
    def post(self, request, pk):
        ...
        log_access(request, AuditLog.Action.UPDATE, obj=evolution, obj_repr=f"Evolução finalizada #{evolution.id}")
        return Response(self.serialize_evolution(evolution, request))
...
class EvolutionDuplicateView(ClinicalPatientMixin, APIView):
    ...
    def post(self, request, pk):
        ...
        serializer.is_valid(raise_exception=True)
        evolution = serializer.save()
        log_access(request, AuditLog.Action.CREATE, obj=evolution, obj_repr=f"Evolução duplicada #{evolution.id}")
        return Response(self.serialize_evolution(evolution, request), status=status.HTTP_201_CREATED)
...
class TreatmentGoalListCreateView(ClinicalPatientMixin, APIView):
    ...
    def post(self, request, patient_id):
        ...
        log_access(request, AuditLog.Action.CREATE, obj=goal, obj_repr=f"Meta terapêutica #{goal.id}")
...
class TreatmentGoalDetailView(ClinicalPatientMixin, APIView):
    ...
    def patch(self, request, pk):
        ...
        serializer.is_valid(raise_exception=True)
        serializer.save()
        log_access(request, AuditLog.Action.UPDATE, obj=goal, obj_repr=f"Meta terapêutica #{goal.id}")
        return Response(serializer.data)

    def delete(self, request, pk):
        goal = self.get_goal(pk)
        goal.archive()
        log_access(request, AuditLog.Action.UPDATE, obj=goal, obj_repr=f"Meta terapêutica arquivada #{goal.id}")
...
class ClinicalDocumentListCreateView(ClinicalPatientMixin, APIView):
    ...
    def post(self, request, patient_id):
        ...
        log_access(request, AuditLog.Action.CREATE, obj=document, obj_repr=f"Documento clínico #{document.id}")
        return Response(
            ClinicalDocumentSerializer(
                document,
                context={"request": request, "patient": patient},
...
class ClinicalDocumentDetailView(ClinicalPatientMixin, APIView):
    ...
    def patch(self, request, pk):
        ...
        serializer.is_valid(raise_exception=True)
        serializer.save()
        log_access(request, AuditLog.Action.UPDATE, obj=document, obj_repr=f"Documento clínico #{document.id}")
        return Response(serializer.data)

    def delete(self, request, pk):
        document = self.get_document(pk)
        document.soft_delete()
        log_access(request, AuditLog.Action.UPDATE, obj=document, obj_repr=f"Documento arquivado #{document.id}")
        return Response(status=status.HTTP_204_NO_CONTENT)
...
class ClinicalDocumentDownloadView(ClinicalPatientMixin, APIView):
    def get(self, request, pk):
        ...
        log_access(request, AuditLog.Action.EXPORT, obj=document, obj_repr=f"Download do documento #{document.id}")
        return FileResponse(
            stream,
            as_attachment=True,

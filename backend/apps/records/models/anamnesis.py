...
class Anamnesis(ClinicalTenantModel):
    patient = models.OneToOneField("patients.Patient", on_delete=models.PROTECT, related_name="anamnesis", verbose_name="Paciente")
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, related_name="anamneses_created", verbose_name="Criado por")

    class Meta:
        verbose_name = "Anamnese"
        verbose_name_plural = "Anamneses"
        indexes = [models.Index(fields=["organization", "patient"], name="anamnesis_org_patient_idx")]

...
class PatientWorkspaceListSerializer(PatientRepresentationMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = Patient
        fields = [
            "id", "full_name", "social_name", "display_name", "photo_url",
            "masked_cpf", "birth_date", "age", "phone", "whatsapp", "email",
            "status", "status_display", "is_active", "therapist",
            "therapist_name", "payer_type", "insurance_name",
            "reminders_enabled", "reminder_recipient", "created_at", "updated_at",
        ]
        read_only_fields = fields
...
class PatientWorkspaceDetailSerializer(PatientRepresentationMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = Patient
        fields = [
            "id", "full_name", "social_name", "photo_url", "cpf",
            "formatted_cpf", "masked_cpf", "rg", "birth_date",
            "treatment_start_date", "age", "gender", "marital_status",
            "profession", "social_network", "email", "phone", "whatsapp",
            "address", "therapist", "therapist_name", "professionals", "status",
            "status_display", "attendance_type", "modality", "payer_type",
            "insurance_name", "session_value", "planned_frequency",
            "reminders_enabled", "reminder_recipient", "referral_source", "tags",
            "emergency_contact_name", "emergency_contact_relationship",
            "emergency_contact_phone", "guardian_name", "guardian_cpf",
            ...
            "financial_responsible_naturality", "financial_responsible_occupation",
            "financial_responsible_relationship", "consent_terms_accepted",
            "consent_at", "notes", "is_active", "deleted_at", "created_at",
            "updated_at",
        ]
        read_only_fields = [
            "id", "photo_url", "formatted_cpf", "masked_cpf", "therapist_name",
            "professionals", "status_display", "consent_at", "is_active",
            "deleted_at", "created_at", "updated_at", "age",
        ]
...
class PatientWorkspaceFormSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Patient
        fields = [
            "full_name", "social_name", "photo", "cpf", "rg", "birth_date",
            "treatment_start_date", "gender", "marital_status", "profession",
            "social_network", "email", "phone", "whatsapp", "address",
            "therapist", "professional_ids", "status", "attendance_type",
            "modality", "payer_type", "insurance_name", "session_value",
            "planned_frequency", "reminders_enabled", "reminder_recipient",
            "referral_source", "tags", "emergency_contact_name",
            "emergency_contact_relationship", "emergency_contact_phone",
            "guardian_name", "guardian_cpf", "guardian_phone", "guardian_email",
            "guardian_relationship", "financial_responsible_name",
            "financial_responsible_cpf", "financial_responsible_phone",
            "financial_responsible_email", "financial_responsible_marital_status",
            "financial_responsible_naturality", "financial_responsible_occupation",
            "financial_responsible_relationship", "consent_terms_accepted", "notes",
        ]
        extra_kwargs = {
    ...
    def validate_photo(self, uploaded_file):
        ...
        if uploaded_file.content_type not in {"image/jpeg", "image/png", "image/webp"} or extension not in {".jpg", ".jpeg", ".png", ".webp"}:

...
class PatientDashboardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Patient
        fields = [
            "id", "full_name", "social_name", "display_name", "masked_cpf",
            "age", "phone", "whatsapp", "email", "status", "status_display",
            "tags", "therapist", "therapist_name", "attendance_type",
            "modality", "payer_type", "insurance_name", "last_session",
            "next_session", "next_session_status", "latest_evolution_at",
            "latest_evolution_id", "total_sessions", "missed_sessions",
            "documents_count", "active_goals_count", "has_anamnesis",

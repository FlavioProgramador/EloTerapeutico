...
class PatientDashboardSerializer(serializers.ModelSerializer):
    ...
    missed_sessions = serializers.IntegerField(read_only=True, default=0)
    documents_count = serializers.IntegerField(read_only=True, default=0)
    active_goals_count = serializers.IntegerField(read_only=True, default=0)
    has_anamnesis = serializers.BooleanField(read_only=True, default=False)

...
from ..models import Appointment, TelemedicineRoom
from .summary import (
...
class AppointmentListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "status", "status_display", "modality", "modality_display",
            "appointment_type", "type_display", "room", "room_name", "session_value",
            "is_recurring", "recurrence", "package", "telemedicine_status",
        ]
...
class AppointmentDetailSerializer(AppointmentListSerializer):
    ...
    class Meta(AppointmentListSerializer.Meta):
        fields = AppointmentListSerializer.Meta.fields + [
            "patient_data", "therapist_data", "participant_data", "notes",
            "cancellation_reason", "origin", "parent_appointment", "reminders",
            "telemedicine", "created_at", "updated_at",
        ]
